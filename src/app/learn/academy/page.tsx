...
import { School, Building, Landmark, LineChart, Sparkles, Bot } from 'lucide-react'; // Removed Star from import
  ...
  return (
    <div className="flex flex-col">
      <PageHeader
        ...
        description="Your central hub for mastering the new landscape of real estate with Gemini. Choose a curriculum, complete courses, and earn certifications."
            ...
            <Card className="bg-primary/10 border-primary/20">
                ...
                <CardContent className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="p-4 bg-background/50 rounded-lg text-center">
                        ...
                        <p className="text-4xl font-bold text-primary flex items-center justify-center gap-2">3</p> 
                    </div>
        ...
        <section>
            <Card className="bg-amber-500/10 border-amber-500/20 text-center">
                <CardHeader>
                    ...
                    <CardTitle className="text-2xl font-bold">New: Gemini AI Kickstart</CardTitle>
